...
Twitter.prototype.unlocateAll = function (reconnect) {
  this.removeAllFilters(FILTER_TYPE_LOCATION, reconnect)
}
...
Twitter.prototype.unfollowAll = function (reconnect) {
  this.removeAllFilters(FILTER_TYPE_FOLLOW, reconnect)
}
...
Twitter.prototype.unlanguageAll = function (reconnect) {
  this.removeAllFilters(FILTER_TYPE_LANGUAGE, reconnect)
}
